...
from nr_enhanced_v2_utils.px4_utils.core_funcs import (
...
from nr_enhanced_v2_utils.controller.nr_enhanced import newton_raphson_enhanced


from nr_enhanced_v2_utils.main_utils import BANNER
from nr_enhanced_v2_utils.transformations.adjust_yaw import adjust_yaw
from nr_enhanced_v2_utils.px4_utils.flight_phases import FlightPhase
...
class OffboardControl(Node):
    def __init__(self, platform_type: PlatformType, trajectory: TrajectoryType = TrajectoryType.HOVER, hover_mode: int|None = None,
        ...
        flight_period = flight_period_ if flight_period_ is not None else 30.0 if self.sim else 60.0
         ...
         # Initialize PyJoules energy monitoring if enabled        
        if self.pyjoules_on:
